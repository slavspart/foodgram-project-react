...
class UserSerializer(UserSerializer):
    ...
    class Meta:
        model = User
        fields = ('email','id', 'username', 'first_name', 'last_name', 'is_surbscribed')
...
class SubscriptionSerializer(serializers.ModelSerializer):
    ...
    first_name = serializers.CharField(required=False, source='author.first_name')
    last_name = serializers.CharField(required=False, source='author.last_name')
    ...
    def get_recipes(self, obj):
        ...
        if 'recipes_limit' in self.context.get('request').query_params:
            recipes_limit = int(self.context.get('request').query_params.get('recipes_limit'))
    ...
    def save(self, **kwargs):
        ...
        self.instance=Subscription.objects.create(author=author, follower=follower)
