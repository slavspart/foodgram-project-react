...
from .serializers import UserRegistrSerializer, UserSerializer, SubscriptionSerializer
...
class CustomUserViewsSet(UserViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        # переписываем метод, чтобы отображать True, если есть подписка на этого автора
